...
public class SearchSDCardVideoActivity extends HiActivity implements OnClickListener{
	...
	public void onClick(View v) {
		...
		} else if (i == R.id.sd_card_half_day_ll) {
			Bundle bundle = new Bundle();
		...
		} else if (i == R.id.sd_card_a_day_ll) {
			Bundle bundle = new Bundle();
		...
		} else if (i == R.id.sd_card_week_ll) {
			Bundle bundle = new Bundle();
		...
		} else if (i == R.id.sd_card_self_ll) {
